...
Run from the project root: python scripts/setup_database.py
...
def setup_database():
    ...
    # Create stops in route-flow order (order field preserves this for the driver form)
    stop_names = [
        "Gjorce Petrov Polyclinic",
        "Gjorce Petrov Cinema",
        "Gjorce Petrov Old Market",
        "Vlae Porta",
        "Vlae",
        "Dolno Nerezi",
        "Skopje City Archives",
        "Karposh 3 Gas Station",
        "Bucharest Polyclinic",
        "Taftalidze T",
        "Taftalidze Market",
        "Karposh 3 TC City Mall T",
        "Restaurant Imes",
        "Primary School Lazo Trpovski",
        "Hospital 8mi Septemvri",
        "Karposh 2",
        "Mal Odmor",
        "Bunjakovec Shopping Center",
        "Bunjakovec Porta",
        "Centar Record",
        "Zelen Pazar",
        "Kuzman Josifoski Pitu Primary School",
        "Championche",
        "Kisela Voda Przino",
        "Home For The Blind",
        "Krume Kepeski Primary School",
        "Bilna Apteka",
        "Cheshma Kisela Voda Maxi",
        "Jugodrvo Olympic Pool",
        "Vero Jambo",
        "Railway Station",
        "Intercity Bus",
        "Tobacco Factory",
        "Dimitar Vlahov Secondary School",
        "Rade Koncar Petrol Station",
        "Transporten Center T",
        "TC Skopjanka",
        "Aerodrom Tobacco 2",
        "TC Tri Biseri",
        "Posta Telecom",
        "Most Goce Delchev Theater",
        ...
        "Bitpazar 2 Shopping Center",
        "Primary School Bitola Congress",
        "Hotel Continental",
    ]
    stops_to_create = [Stop(name=name, order=i) for i, name in enumerate(stop_names)]
    ...
    print(f"✅ Created {len(stop_names)} stops in route-flow order")
